...
>
  <div
    ...
    class="px-2 py-2 flex gap-x-2 items-center justify-between border-r border-gray-300  bg-gray-800 text-white"
  >
    {#if nav}
      <button class="flex items-center gap-x-2  py-2 rounded text-white">
        <Logo isDark W={12} strokeWidthTop={1} strokeWidthBottom={2} />
