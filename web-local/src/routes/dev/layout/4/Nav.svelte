...
<nav class="pl-2 border-r border-gray-200 bg-gray-800 text-white">
  <div
    style="height: 40px"
    class="flex py-4 px-2 justify-between items-center gap-x-2 "
  >
  ...
  <div class="flex flex-col gap-y-4 px-2 py-4">
    <section>
      <h2>Sources</h2>
